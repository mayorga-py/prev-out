...
#ifndef PREV_OUT_SWIFT_H
#define PREV_OUT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="prev_out",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8prev_out11AppDelegate")
...
SWIFT_CLASS("_TtC8prev_out17MainFlutterWindow")
